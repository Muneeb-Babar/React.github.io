...
return <div>
    ...
    <div  class="ac22b0e1"><a href="/" class="_5afdd59e d19dc9be" ><svg  height="25" viewBox="0 0 36.289 20.768" alt="Logo" class="_10c831ef"><path style={{color:'blue'}} d="M18.9 20.77V0h4.93v20.77zM0 10.39a8.56 8.56 0 1 1 8.56 8.56A8.56 8.56 0 0 1 0 10.4zm5.97-.01a2.6 2.6 0 1 0 2.6-2.6 2.6 2.6 0 0 0-2.6 2.6zm27 5.2l-1.88-1.87-1.87 1.88H25.9V12.3l1.9-1.9-1.9-1.89V5.18h3.27l1.92 1.92 1.93-1.92h3.27v3.33l-1.9 1.9 1.9 1.9v3.27z"></path></svg></a></div>
    <div><input  placeholder='Pakistan'/></div>
    <div className='input1'><input type='text' placeholder='Find Mobiles,cars' />
    <span style={{backgroundColor:'#002f34', padding:'3px'}}><i class="fa-solid fa-magnifying-glass" style={{color:'white'}}></i></span>
...
<div className='main3 container'>
    <span style={{display:'flex'}}><h6>All categories</h6><img src='https://www.olx.com.pk/assets/iconArrowDown_noinline.ec05eae7013321c193965ef15d4e2174.svg'  width={'15px'}/></span>
...
<div className='container'><h6 style={{textAlign:'left',marginTop:'10px'}}>All categories</h6></div>
<div className='main5 container'>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/mobiles.8c768c96bfde33f18fcf5af2a8b9cf71.png' width={60}/><p>Mobile</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/vehicles.29fb808d5118f0db56f68a39ce5392e2.png' width={60}/><p>Vehicles</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/property-for-sale.e3a00dbfdaa69fe5f713665f1069502f.png' width={60}/><p>Property For Sale</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/property-for-rent.8436595fbaa90d47f0178006f57090a8.png' width={60}/><p>Property For <br/> Rent</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/electronics-home-appliances.46e034dd8adca44625c2c70e4d1b5984.png' width={60}/><p>Electronics & <br/> Home Appliances</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/bikes.4dcd02c49b2b83aa5b4d629d1e2b383e.png' width={60}/><p>Bikes</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/business-industrial-agriculture.704a6ffb9081bc94b11c102cc613670f.png' width={60}/><p>Business,<br/> Industrial & <br/> Agriculture</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/services.dc6aef196c0403dc61b0ee813f66fa5b.png' width={60}/><p>Services</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/jobs.79e6136dda02111cf8e7afe26b9e0f93.png' width={60}/><p>Jobs</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/animals.62d396e85f7523dbc8ff23889fdd5c31.png' width={60}/><p>Animals</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/furniture-home-decor.66bcf157a53ea4c736a5b0af41219475.png' width={60}/><p>Furniture & <br/> Home Decor</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/fashion-beauty.dd2cf7638c29b0e5c084a6673dd94dd7.png' width={60}/><p>Fashion & <br/> Beauty</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/books-sports-hobbies.6fee8d841b332d65a10f050f4a2ee1c8.png' width={60}/><p>Books, Sports <br/> & Hobbies</p></div>
    <div style={{display:'flex',flexDirection:'column',textAlign:'left', fontSize:'.8rem',alignItems:'center', }}><img src='https://www.olx.com.pk/assets/kids.cd8d8864804f1c35dd6a7df68268a48d.png' width={60}/><p>Kids</p></div>
</div>
</div>
}
